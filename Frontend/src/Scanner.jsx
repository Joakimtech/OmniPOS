...
const Scanner = () => {
  ...
  // window.location.hostname automatically detects the IP or domain used to access the page
  const currentIP = window.location.hostname; 
  
  // This routes requests to port 8000 on the same host detected by the browser
    ...
    <div style={{...containerStyle, backgroundColor: theme.bg, color: theme.text}}>
      ...
      <div style={{...footerStyle, color: theme.subtext}}>
        ...
        <div style={{...indicatorStyle, backgroundColor: theme.card}}>
          ...
          {/* Displays the detected host IP or domain on the UI */}
          Host IP: {currentIP}
        </div>
      </div>
    </div>
